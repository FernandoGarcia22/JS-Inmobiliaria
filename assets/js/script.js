...
const p_alquiler = [
  ...
  },
  {
    ...
    descripcion:
      "Este apartamento de lujo cuenta con las habitaciones temáticas más llamativas",
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="${p_venta.smoke ? "text-success" : "text-danger"}">
                    <i class="fas ${
                      p_venta.smoke ? "fa-smoking" : "fa-smoking-ban"
                    }"></i> 
...
for (const p_alquiler of p_alquiler_tres) {
  cartaA.innerHTML += `<div class="col-md-4 mb-4"> 
        <div class="card">
            <img src=${p_alquiler.src} class="card-img-top" alt=${
    p_alquiler.nombre
  }/>
            <div class="card-body">
